                    ...
                    <div className="container">
                        ...
                        <div className="favourite__products">
                            <div className="favourite__product">
                                <img src="http://localhost:4000/uploads/product1-1.jpg" alt="product" className="favourite__product-img"/>
                                <Link className="favourite__product-data" to={'/shop/:id'}>
                                    <div className="favourite__product-name title2" >Високі кросівки</div>
                                    <p className="favourite__product-brand">Nike</p>
                                    <p className="favourite__product-price"><span>1 399 </span> UAH</p>
                                </Link>
