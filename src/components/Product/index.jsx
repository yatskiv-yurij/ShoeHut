...
export const Product = ({edit, data}) => {
    ...
    return ( 
        ...
        { !data &&  <>
            ...
            />
            <Link className="product__data" to={link}>
                <p className="product__name">Кросівки</p>
                <p className="product__brand">Бренд</p>
            </Link>
            <div className="product__prices">
                <p className="product__new-price"><span>1499</span> UAH</p>
                <p className="product__old-price"><span>1499</span>UAH</p>
            </div>
        </>}
